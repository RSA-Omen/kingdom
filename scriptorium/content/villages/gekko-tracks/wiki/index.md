...
- **OCR'd** — glm-ocr (visual model on gkgpu-01) extracts amounts, dates, and merchant tokens. Falls back to Tesseract if gkgpu-01 is unreachable.
...
See [[gekko-tracks/receipts]] for the full OCR stack, operating procedure, and troubleshooting guide.
