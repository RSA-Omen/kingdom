...
- **The Villages** — every app that meets the Gekko Standard (Gekko Tracks, PDF Removal, Interceptor, etc.) — they live elsewhere on the server, the Kingdom only watches
- **The Bridges** — `bridges/` (integrations to systems we don't control: Power Automate, Copilot Studio, Pronto Xi)
